      ...
      function checkGettingClose(outputText) {
        var sensitivity = 1; // define how large of an area to search
      ...
      function createObstacles(numObstaclesOfType,obstacleType) {
        var xChosen = [];
        var yChosen = [];
        ...
        for (i = 0; i < numObstaclesOfType; i++) {
          ...
          obstacles[obstacleIndex] = obstacleType;
        }
      ...
      function startGame() {
        ...
        createObstacles(numTraps,1);
        createObstacles(numTreasures,2);
        createObstacles(numObstacles,3);
